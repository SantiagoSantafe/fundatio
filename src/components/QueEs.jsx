        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              en Colombia. Conecta con fundaciones comprometidas, apoya con
              donaciones transparentes, y sigue el impacto de tu generosidad en
              tiempo real.
            </p>

            {/* Quick stats (adapted, enlazan a Panorama) */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {benefits.map((benefit, i) => (
                <div
                  key={i}
                  className="bg-gray-50 rounded-xl p-4 border border-gray-100 hover:shadow-md hover:bg-white transition-all duration-300"
                >
